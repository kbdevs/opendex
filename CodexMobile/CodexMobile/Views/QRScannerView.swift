...
struct QRScannerView: View {
    ...
    private func bridgeUpdateView(prompt: CodexBridgeUpdatePrompt) -> some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                bridgeUpdateStep(number: "1", title: "Update Opendex", detail: prompt.command, showsCopyButton: true)
                bridgeUpdateStep(number: "2", title: "Start it again", detail: "Run ./run-local-opendex.sh")
    ...
    private var scannerOverlay: some View {
        VStack(spacing: 24) {
            ...
            Text("Scan the QR code from the Opendex bridge")
...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        title: "Update Opendex on your Mac before scanning",
        message: "This QR code was generated by a different Opendex bridge version. Update the bridge on your Mac before scanning a new QR code.",
