...
// Purpose: Defines the wire payloads, device trust records, and crypto helpers for secure Opendex sessions.
...
enum CodexSecureTransportError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .invalidQR(let message),
            ...
            return message
        case .decryptFailed:
            return "Unable to decrypt the secure Opendex payload."
        }
    }
}
